...
// rpc: {
//   3: "wss://ropsten.infura.io/ws/v3/62f3555371db4581aba56bbe1a7b063d"
// },
...
export default {
  ...
  methods: {
    ...
    async sendTransaction() {
      await this.web3.eth
        .sendTransaction({
          from: "0x3236AB0D765fCF33d5fb8353ED2e057776950017",
          to: "0x84Be48d6BAB2478cc4132d893eB3155328415d0a", //trust test eth
    ...
    signTrust: async function () {
      await web4.eth
        .sign(
          "0x84Be48d6BAB2478cc4132d893eB3155328415d0a",
          "0x84Be48d6BAB2478cc4132d893eB3155328415d0a"
        )
        .then((res) => {
          console.log(res);
